					...
					<ul class="app_list">
						<li class="clear">
                            ...
                            <div class="app_content email_area">
                                <input type="text" class="w160" id="email_lbl" name="email_1" title="이메일 주소" />
                                <span class="ico_space">@</span>
                                <input type="text" class="w160" name="email_2" title="이메일 제공업체 입력" />										
						...
						<li class="clear">
							...
							<div class="app_content"><input type="password" class="w100p" id="pwd_lbl" name="password" placeholder="비밀번호를 입력해주세요"/></div>
						</li>
						<li class="clear">
							<label for="pwd2_lbl" class="tit_lbl pilsoo_item">비밀번호 확인</label>
							<div class="app_content"><input type="password" class="w100p" id="pwd2_lbl" name="password_check" placeholder="비밀번호를 다시 한번 입력해주세요"/></div>
						</li>
						<li class="clear">
						...
						<li class="clear">
							...
							<div class="app_content radio_area">
								<input type="radio" class="css-radio" id="mmm_lbl" value="male" name="gender"><label for="mmm_lbl">남</label>
								<input type="radio" class="css-radio" id="www_lbl" value="female" name="gender"><label for="www_lbl">여</label>
							</div>
						</li>
						<li class="clear">
